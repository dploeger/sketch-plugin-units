...
export function MochaJSDelegate(selectorHandlerDict) {
  ...
  this.setHandlerForSelector = function(selectorString, func) {
    ...
    if (!handlerHasBeenSet) {
      ...
      */
      ...
      dynamicFunction = eval("(function(" + args.join(",") +
        "){ return dynamicHandler.apply(this, arguments); })");

      delegateClassDesc.addInstanceMethodWithSelector_function_(selector,
        dynamicFunction);
    }
  };
  ...
  if (typeof selectorHandlerDict == "object") {
    for (var selectorString in selectorHandlerDict) {
      this.setHandlerForSelector(selectorString, selectorHandlerDict[
        selectorString]);
    }
  }
};
